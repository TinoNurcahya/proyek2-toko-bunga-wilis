  ...
  <div class="container-fluid">
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        ...
        <form action="{{ route('admin.tanaman.store') }}" method="POST" enctype="multipart/form-data" id="formTanaman">
          @csrf
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" name="nama_ilmiah" class="form-control" value="{{ old('nama_ilmiah') }}"
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="text" name="asal_tanaman" class="form-control"
                placeholder="Contoh: Meksiko & Amerika Tengah" value="{{ old('asal_tanaman') }}">
              @error('asal_tanaman')
                <div class="text-danger small">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" name="ukuran_detail" class="form-control"
                placeholder="Contoh: Tinggi ±60 cm, diameter pot 17 cm" value="{{ old('ukuran_detail') }}">
              @error('ukuran_detail')
                <div class="text-danger small">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="file" name="foto_utama" class="form-control" id="fotoUtama" required
            ...
            <div class="col-md-6 mb-3">
              <label class="form-label">Gallery Foto (Maksimal 3)</label>
              <input type="file" name="foto_produk[]" class="form-control" id="fotoGallery" multiple
                accept=".jpg,.jpeg,.png,.gif,.webp" max="3">
              <small class="text-muted">Pilih maksimal 3 foto. Format: JPG, PNG, GIF, WebP. Maks: 2MB per foto</small>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="input-group">
                        ...
                        <input type="number" name="harga[{{ $item->id_ukuran }}]" class="form-control" min="0"
                          placeholder="0" value="{{ old('harga.' . $item->id_ukuran) }}">
                      </div>
                    ...
                    <td>
                      <input type="number" name="stok[{{ $item->id_ukuran }}]" class="form-control" min="0"
                        placeholder="0" value="{{ old('stok.' . $item->id_ukuran) }}">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <textarea name="penyiraman" class="form-control" rows="3" placeholder="Contoh: Siram 2-3 kali seminggu">{{ old('penyiraman') }}</textarea>
              @error('penyiraman')
                <div class="text-danger small">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-md-6 mb-3">
              ...
              <textarea name="cahaya" class="form-control" rows="3" placeholder="Contoh: Cahaya tidak langsung">{{ old('cahaya') }}</textarea>
              @error('cahaya')
                <div class="text-danger small">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="row">
            {{-- HAPUS: Field "Suhu" (diganti dengan "Suhu & Kelembapan") --}}
            <div class="col-md-12 mb-3">
              <label class="form-label">Suhu & Kelembapan</label>
              <textarea name="suhu_dan_kelembapan" class="form-control" rows="3"
                placeholder="Contoh: Suhu 18-25°C, Kelembapan 60-80%">{{ old('suhu_dan_kelembapan') }}</textarea>
          ...
          {{-- HAPUS: Tips Tambahan (tidak ada di controller/database) --}}

          {{-- ================= ACTION ================= --}}
          <div class="d-flex gap-2 mt-4 pt-3 border-top">
            <button type="submit" class="btn btn-primary px-4">
              <i class="fas fa-save me-2"></i>Simpan Tanaman
            </button>
