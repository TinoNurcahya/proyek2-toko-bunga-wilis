  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav me-auto ms-5 align-items-center montserrat">
        <li class="nav-item">
          <a class="nav-link me-4 {{ request()->is('/') ? 'active' : '' }}" href="{{ url('/') }}#">Beranda</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-4 {{ request()->is('produk*') ? 'active' : '' }}" href="{{ url('/produk') }}">Produk</a>
        </li>
        <li class="nav-item">
          ...
          @auth
            @if (Auth::user()->hasVerifiedEmail())
              <div class="user-hover-container position-relative me-3">
                <a class="text-white position-relative text-decoration-none" href="{{ route('profile.edit') }}">
                ...
                <div class="user-popup position-absolute border border-success">
                  <div class="text-center">
                    <ul>
                      <li><a class="dropdown-item fw-semibold" href="{{ route('profile.edit') }}">Akun
                          saya</a>
                      </li>
                      <li><a class="dropdown-item fw-semibold" href="{{ route('profile.pesanan') }}">Pesanan
                          saya</a>
                      </li>
                      <li>
            ...
            @else
              ...
              <div class="user-hover-container position-relative">
                <a class="text-decoration-none d-flex align-items-center" href="#" style="pointer-events: none;">
                  <div
                    class="profile-icon d-flex align-items-center justify-content-center rounded-circle bg-warning border"
