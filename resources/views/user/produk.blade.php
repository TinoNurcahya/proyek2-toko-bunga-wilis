...
@section('content')
  ...
  <section id="hero" class="text-white d-flex align-items-center justify-content-center daunbg">
    ...
    <div class="img-paralax-hero">
      <img id="tanamanhero" src="{{ asset('images/default/tanamanhero1.png') }}" class="parallax" data-rellax-speed="-6"
        alt="">
      <img id="tanamanhero-2" src="{{ asset('images/default/tanamanhero1.png') }}" class="parallax" data-rellax-speed="-6"
        alt="">
      <img id="tanamanhero-3" src="{{ asset('images/default/tanamanhero2.png') }}" class="parallax" data-rellax-speed="-7"
        alt="">
      <img id="tanamanhero-4" src="{{ asset('images/default/tanamanhero2.png') }}" class="parallax" data-rellax-speed="-7"
        alt="">
    </div>
  ...
  <section id="produk" class="py-5">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <div class="filter-bar d-none d-md-flex flex-wrap align-items-center gap-3 mb-4 p-3 bg-white rounded shadow-sm">
            @include('user.partials.filter-bar')
          </div>
        </div>
      </div>
