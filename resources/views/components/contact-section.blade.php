    ...
    <div class="container">
        ...
        <div class="text-center">
            <h3 class="fw-semibold mb-1 position-relative d-inline-block fraunces" data-aos="fade-down"
                data-aos-offset="350" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
                Kontak
            </h3>
        </div>
        ...
        <div class="row mt-4 align-items-stretch">
            ...
            <div class="col-md-6 mb-4 mb-md-0">
                <div class="map-container" data-aos="zoom-in-up" data-aos-offset="350"
            ...
            <!-- Kolom Form Kontak -->
            <div class="col-md-6">
                <div class="contact-card" data-aos="zoom-in-up" data-aos-offset="350"
                    data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
                    ...
                    <form id="kontak-form" action="https://formspree.io/f/myzlwyqp" method="POST" class="montserrat">
                        ...
                        <input type="text" class="form-control mb-4" id="name" name="name" placeholder="Nama"
                            required>
